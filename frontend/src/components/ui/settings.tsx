                ...
                <div className="space-y-5">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-sm text-white/60">
                        Receive intelligent suggestions as you work
                      </p>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-neutral-500">
                      How proactive should AI suggestions be
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-neutral-500">
                      Select which AI model powers your experience
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-xl border border-white/10 p-6">
                <div className="space-y-5">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-white/80 min-w-[40px] text-center">
                          14px
                        </span>
                        <button className="bg-black/60 border border-white/10 w-8 h-8 rounded-md flex items-center justify-center text-white/80 hover:bg-black/80 transition-colors">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-sm text-white/60">
                        Wrap text to stay within the editor width
                      </p>
                      <div className="relative inline-flex h-6 w-11 items-center rounded-full bg-white/10 transition-colors hover:bg-white/20">
                        <span className="inline-block h-4 w-4 transform rounded-full bg-indigo-400 translate-x-6 transition-transform"></span>
                      </div>
      ...
      },
      {
        ...
        content: (
          <div>
            ...
            <p className="mb-6 text-white/60">
              Configure the appearance and behavior of the application
              interface.
            </p>
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-xl border border-white/10 p-6">
                <div className="space-y-5">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-neutral-500">
                      Where the application dock should appear
                    </p>
                  </div>
            ...
            >
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-xl border border-white/10 p-6">
                ...
                <p className="mb-4 text-white/60">
                  You can customize any keyboard shortcut by clicking on the
                  shortcut and pressing your preferred key combination.
                </p>
                <button
          ...
          <div>
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-xl border border-white/10 p-6">
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-sm text-white/60">
                        Allow your interactions to be used for improving AI
                        models
                      </p>
                      <div className="relative inline-flex h-6 w-11 items-center rounded-full bg-white/10 transition-colors hover:bg-white/20">
            ...
            >
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-xl border border-rose-500/20 p-6">
                ...
                <p className="mb-4 text-white/60">
                  You can request the deletion of all your personal data from
                  our servers.
                </p>
                <button
                  className="relative overflow-hidden group bg-gradient-to-r from-rose-500 to-red-600 
                  hover:from-rose-600 hover:to-red-700 text-white font-medium py-2 px-4 rounded-md 
                  transition-all duration-300"
                >
                  <div
                    className="absolute inset-0 w-full h-full bg-gradient-to-r from-rose-400/0 via-white/20 to-rose-400/0 
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-xl border border-white/10 p-6">
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-neutral-500">
                      How long until you're automatically logged out
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-xl border border-white/10 p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center pb-3 border-b border-white/10">
                    ...
                    <span className="bg-green-500/20 text-green-200 text-xs px-2 py-1 rounded-full">
                      Active
                    </span>
                  </div>
                  <div className="flex justify-between items-center pb-3 border-b border-white/10">
                    <div>
                      ...
                      <div className="text-xs text-white/60">
                        Last active: Apr 5, 2025 · San Francisco, CA
                      </div>
                    </div>
                    <button className="text-rose-400 text-xs hover:underline">
                      Revoke
                    </button>
                  </div>
                </div>
            ...
            >
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-xl border border-white/10 p-6">
                <p className="mb-4 text-white/80">
                  Lumen is an AI-powered coding environment designed to enhance
                  developer productivity and creativity through intelligent
                  assistance.
                </p>
                ...
                <div>
                  ...
                  <p className="text-white/60 mb-1">
                    Developed by the Lumen Team
                  </p>
                  <p className="text-white/60 mb-4">
                    © 2025 Lumen AI, Inc. All rights reserved.
                  </p>

                  <div className="flex space-x-4">
                    <button
                      className="relative overflow-hidden group bg-gradient-to-r from-indigo-500 to-purple-600 
                      hover:from-indigo-600 hover:to-purple-700 text-white font-medium py-2 px-4 rounded-md 
                      transition-all duration-300"
                    >
                      <div
                ...
                <div className="space-y-6">
                  <div>
                    <div className="flex items-center mb-2">
                      ...
                      <span className="bg-indigo-500/20 text-indigo-200 text-xs px-2 py-1 rounded-full">
                        Current
                      </span>
                    </div>
                    ...
                    <ul className="list-disc pl-6 space-y-3">
                      <li>
                        ...
                        <p className="text-white/60 text-sm mt-1">
                          Improved code suggestions with context-aware
                          completions across multiple files
                        </p>
                      </li>
                      <li>
                        <span className="font-medium">
                        ...
                        <p className="text-white/60 text-sm mt-1">
                          Work with team members simultaneously on the same
                          project with live cursors and changes
                        </p>
                      </li>
                      <li>
                        <span className="font-medium">
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      <li>
                        ...
                        <p className="text-white/60 text-sm mt-1">
                          Fixed an issue with autocomplete in TypeScript files
                        </p>
                      </li>
                      <li>
                        <span className="font-medium">
                        ...
                        <p className="text-white/60 text-sm mt-1">
                          Better screen reader support and keyboard navigation
                        </p>
                      </li>
                    </ul>
                  </div>
...
export function SettingsPage() {
  ...
  const currentCategory = settingsData.find(
